...
public class OmsWeixinMenuDTO {
     ...
     * 子菜单
     */
    private List<OmsWeixinMenuDTO> childOmsWeixinMenuDTOs;
    ...
    public List<OmsWeixinMenuDTO> getChildOmsWeixinMenuDTOs() {
        return childOmsWeixinMenuDTOs;
    }

    public void setChildOmsWeixinMenuDTOs(List<OmsWeixinMenuDTO> childOmsWeixinMenuDTOs) {
        this.childOmsWeixinMenuDTOs = childOmsWeixinMenuDTOs;
    }
}